gio: file:///home/piyush_singh/Desktop/SSD/webpage/ls.cpp: Error when getting information for file “/home/piyush_singh/Desktop/SSD/webpage/ls.cpp”: No such file or directory
	...
	while(1){
		...
		if(fullcommands[0]=="search"){
			...
			if((fullcommands.size()%2) == 0){			//matlab pair me nahi hai filename and destination.
				NORMAL_MODE(maindirectory.c_str());
				printf("----> MISSING FILENAME OR DESTINATION,RE-ENTER.\n");
			}
			else{
				NORMAL_MODE(maindirectory.c_str());
...
/////////////////////////////////// YAHA SE KARNA TESTING KARNI HAIIIIIIIIIIIIIIIIII /////////////////////////////////////////////////////////////////////////////
	    //////////////////////////////////////////////////////////////////////////////////SDDCSXZSXDCFVCDXSZXDCFVCDXZXDCVFCXZXDCVFCXZXCDFDXZXCDFVDXZXDC
			...
			if((fullcommands.size()%2) == 0){			//matlab pair me nahi hai filename and destination.
				NORMAL_MODE(maindirectory.c_str());
				printf("----> MISSING FOLDERNAME OR DESTINATION,RE-ENTER.\n");
			}
			else{
				NORMAL_MODE(maindirectory.c_str());
				for(int i=1;i<fullcommands.size();i+=2){
	    	...
	    	// NORMAL_MODE(maindirectory.c_str());														//adding NORMAL_MODE(maindirectory.c_str());
	    	// string absolutecreatefolderpathe=resolvepath(fullcommands[2]);		//everywhere because it will refresh the screen
	    	// string createfoldername=fullcommands[1];												//and all the contents in command mode will appear
	    	// createfolder(absolutecreatefolderpathe+"/"+createfoldername);							//properly.
	    }
